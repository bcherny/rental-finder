...
export default class MapControls extends React.Component {
	...
	render() {
      ...
      <label>
      	Work address $<input type="text" value={this.state.workAddress} defaultValue="220 River St. Hoboken NJ" onChange={this.onChangeWorkAddress.bind(this)} style={{ width: '150px' }} />
